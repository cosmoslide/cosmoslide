                      ...
                      <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-6">
                        ...
                        <div className="space-y-2 text-sm">
                          ...
                          <div className="bg-white dark:bg-gray-800 p-2 rounded">
                            ...
                            <p className="font-mono text-xs break-all">
                              https://pleroma.site/notice/ABC123
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <li className="flex items-start">
                          ...
                          <span>
                            ...
                            to search for federated users
                          </span>
                        </li>
                        <li className="flex items-start">
                          <span className="text-blue-500 mr-2">•</span>
                          <span>
                            Paste any fediverse post URL to import and view it
                            locally
                          </span>
                        </li>
                        <li className="flex items-start">
                          <span className="text-blue-500 mr-2">•</span>
                          <span>
                            Paste any fediverse profile URL to follow remote
                            users
                          </span>
                        </li>
                      </ul>
                    ...
                    filteredNotes.length === 0 ? (
                      <div className="bg-white dark:bg-gray-800 rounded-lg p-8 text-center">
                        ...
                        <p className="text-gray-500 dark:text-gray-400">
                          Try searching with a different query or check the URL
                          format
                        </p>
                      </div>
                    ) : (
