...
function FollowRequestsPageContent() {
  ...
  const handleAccept = async (requesterUsername: string) => {
    ...
    try {
      ...
      setFollowRequests(prev => prev.filter(req => req.username !== requesterUsername))
    } catch (error) {
                  ...
                  <div className="flex">
                    ...
                    <div className="text-sm">
                      ...
                      <p className="text-yellow-700 dark:text-yellow-300">
                        Anyone can follow you without approval. To require approval for new followers, 
                        enable "Private Account" in <Link href="/settings" className="underline hover:no-underline">Settings</Link>.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="mt-8 bg-blue-50 dark:bg-blue-900/20 rounded-lg p-6">
                ...
                <ul className="space-y-2 text-sm text-blue-800 dark:text-blue-200">
                  <li className="flex items-start">
                    ...
                    <span>Follow requests appear when your account is set to private or when someone from another server wants to follow you</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-blue-500 mr-2">•</span>
                    <span>Accepting a request allows them to see your posts and updates</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-blue-500 mr-2">•</span>
                    <span>Rejecting a request prevents them from following you, but they can request again</span>
                  </li>
                </ul>
              </div>
            </>
