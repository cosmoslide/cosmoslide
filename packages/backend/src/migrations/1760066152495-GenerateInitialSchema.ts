...
export class GenerateInitialSchema1760066152495 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "timeline_posts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "authorId" uuid, "noteId" uuid, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "REL_022a383fbed2a43534631af18d" UNIQUE ("noteId"), CONSTRAINT "PK_1fafc7c1fa488da4b5b82882a39" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_885a81461f94e2cf074f8f2e8f" ON "actors" ("preferredUsername", "domain") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_12642dfdd299726e6b8732973f" ON "actors" ("actorId") `);
        ...
        await queryRunner.query(`ALTER TABLE "timeline_posts" ADD CONSTRAINT "FK_8e3fb3c0e19f6f276d17bb56929" FOREIGN KEY ("authorId") REFERENCES "actors"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "timeline_posts" ADD CONSTRAINT "FK_022a383fbed2a43534631af18d2" FOREIGN KEY ("noteId") REFERENCES "notes"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "notes" ADD CONSTRAINT "FK_d358080cb403fe88e62cc9cba58" FOREIGN KEY ("authorId") REFERENCES "actors"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "notes" ADD CONSTRAINT "FK_1ad9709ef8450a54e59dd17fdc2" FOREIGN KEY ("sharedNoteId") REFERENCES "notes"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "actors" ADD CONSTRAINT "FK_6e9f8dbdb17e464bb4aae82a157" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "follows" ADD CONSTRAINT "FK_fdb91868b03a2040db408a53331" FOREIGN KEY ("followerId") REFERENCES "actors"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "follows" ADD CONSTRAINT "FK_ef463dd9a2ce0d673350e36e0fb" FOREIGN KEY ("followingId") REFERENCES "actors"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "keypairs" ADD CONSTRAINT "FK_e55f3bd3c77e21ddae0b6575d4e" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "presentations" ADD CONSTRAINT "FK_fa9b1d12f25bfabb72d52118b7e" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "presentations" DROP CONSTRAINT "FK_fa9b1d12f25bfabb72d52118b7e"`);
        await queryRunner.query(`ALTER TABLE "magic_links" DROP CONSTRAINT "FK_1c64b8995a08697016868c80186"`);
        await queryRunner.query(`ALTER TABLE "keypairs" DROP CONSTRAINT "FK_e55f3bd3c77e21ddae0b6575d4e"`);
        ...
        await queryRunner.query(`ALTER TABLE "actors" DROP CONSTRAINT "FK_6e9f8dbdb17e464bb4aae82a157"`);
        await queryRunner.query(`ALTER TABLE "notes" DROP CONSTRAINT "FK_1ad9709ef8450a54e59dd17fdc2"`);
        await queryRunner.query(`ALTER TABLE "notes" DROP CONSTRAINT "FK_d358080cb403fe88e62cc9cba58"`);
        await queryRunner.query(`ALTER TABLE "timeline_posts" DROP CONSTRAINT "FK_022a383fbed2a43534631af18d2"`);
        await queryRunner.query(`ALTER TABLE "timeline_posts" DROP CONSTRAINT "FK_8e3fb3c0e19f6f276d17bb56929"`);
        await queryRunner.query(`DROP TABLE "invitations"`);
        await queryRunner.query(`DROP TABLE "presentations"`);
        await queryRunner.query(`DROP TABLE "magic_links"`);
        await queryRunner.query(`DROP TABLE "users"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_6411ca97c34acb4edd8b28837f"`);
        await queryRunner.query(`DROP TABLE "keypairs"`);
        await queryRunner.query(`DROP TYPE "public"."keypairs_algorithm_enum"`);
        await queryRunner.query(`DROP TABLE "follows"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_12642dfdd299726e6b8732973f"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_885a81461f94e2cf074f8f2e8f"`);
